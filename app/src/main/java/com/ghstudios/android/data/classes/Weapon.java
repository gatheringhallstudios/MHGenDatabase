...
public class Weapon extends Item {
    ...
    public void initializeSharpness() {
        ...
        strSharpness3 = new ArrayList<>(Arrays.asList(strSharpnessBoth[2].split("\\.")));
        ...
        for (int i = 0; i < 7; i++) {
            try {
                sharpness3[i] = Integer.parseInt(strSharpness3.get(i));
            } catch (Exception e) {
                Log.v("ParseSharpness", "Error in sharpness " + sharpness);
                sharpness3 = new int[]{0, 0, 0, 0, 0, 0, 0};
                break;
            }
        }
